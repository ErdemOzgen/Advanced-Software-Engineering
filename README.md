...
- [Refactoring Notes](#refactoring-notes)
	- [Table of Content of Refactoring](#table-of-content-of-refactoring)
		- [Why write bad code?](#why-write-bad-code)
		...
		- [One Level of Abstraction per Function](#one-level-of-abstraction-per-function)
			- [Reading Code from Top to Bottom: _The Stepdown Rule_](#reading-code-from-top-to-bottom-the-stepdown-rule)
	...
	- [Separe Constructing a System from using It](#separe-constructing-a-system-from-using-it)
		- [Separation from main](#separation-from-main)
		- [Dependency Injection](#dependency-injection)
	- [Miths and Misconceptions](#miths-and-misconceptions)
	- [Comments](#comments)
